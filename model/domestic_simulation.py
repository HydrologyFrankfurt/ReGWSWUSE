...
class DomesticSimulator:
    ...
    consumptive_use_tot : numpy.ndarray
        Domestic-specific consumptive use of total water resources. Originally
        read as xr.DataArray. (input)
    consumptive_use_gw : numpy.ndarray
        Domestic-specific consumptive use of groundwater. (calculated)
    consumptive_use_sw : numpy.ndarray
        Domestic-specific consumptive water use of surface waters. (calculated)
    abstraction_tot : numpy.ndarray
        Domestic-specific abstraction of total water resources. Originally read
        as xr.DataArray. (input)
    abstraction_gw : numpy.ndarray
        Domestic-specific abstraction of groundwater. (calculated)
    abstraction_sw : numpy.ndarray
        Domestic-specific abstraction of surface waters. (calculated)
    return_flow_tot : numpy.ndarray
        Domestic-specific total return flow, calculated as the difference
        between abstraction and consumptive use of total water resources.
        (calculated)
    return_flow_gw : numpy.ndarray
        Domestic-specific return flows into groundwater. (calculated)
    return_flow_sw : numpy.ndarray
        Domestic-specific return flows into surface waters. (calculated)
    net_abstraction_gw : numpy.ndarray
        Domestic-specific net abstraction of groundwater. (calculated)
    net_abstraction_sw : numpy.ndarray
        Domestic-specific net abstraction of surface waters. (calculated)
    fraction_gw_use : numpy.ndarray or int
        Domestic-specific relative fraction of groundwater use. Originally
        provided as xr.DataArray or set to 0. (input)
    fraction_return_gw : numpy.ndarray or int
        Domestic-specific relative fraction of return flow to groundwater.
        Originally provided as xr.DataArray or set to 0. (input)
    coords : xarray.Coordinates
        Coordinates of the original dataset for domestic-specific consumptive

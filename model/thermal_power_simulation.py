...
class ThermalPowerSimulator:
    ...
    def __init__(self, tp_data, config):
        ...
        if self.cso_flag:
            ...
            self.coords_idx = \
                cso.get_np_coords_cell_output(tp_data['consumptive_use_tot'],
                                             'thermal power',
...
if __name__ == "__main__":
    ...
    tp = ThermalPowerSimulator(preprocessed_gwswuse_data['thermal_power'],config_test)

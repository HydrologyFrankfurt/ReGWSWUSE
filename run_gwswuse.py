...
from view.output_data_manager_new import output_data_manager
...
def run_gwswuse():
    ...
    end_time = time.time()
    print(f"GWSWUSE software runtime: {end_time - start_time} seconds.")
    return preprocessed_gwswuse_data, gwswuse_check_results, gwswuse_results


if __name__ == "__main__":
    preprocessed_gwswuse_data, gwswuse_check_results, gwswuse_results = \
        run_gwswuse()
